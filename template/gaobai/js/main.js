(function (legend) {
  ...
  function define() {
    ...
    var o = { exports: {} };
    (o.exports = r(require, o.exports, o) || o.exports),
      (modules[e] = o.exports);
  }
  var modules = {};
      ...
      (t.exports = {
        setCookie: function (e, n, t) {
          ...
          if (
            ...
            t.path && (i += "; path=" + t.path),
            t.expired)
          ) {
            var r = new Date();
            r.setTime(r.getTime() + t.expired),
              (i += "; expires=" + r.toGMTString());
          }
          t.secure && (i += "; secure"), (document.cookie = i);
        },
        getCookie: function (e) {
          return (e = new RegExp("(^| )" + e + "=([^;]*)(;|$)").exec(
            document.cookie
          ))
            ? e[2]
            : null;
          ...
          return (
            e.split("&").forEach(function (e) {
              if (e.length > 0 && e.indexOf("=") > -1) {
                var t = e.split("=");
                /\d+/.test(t[1]) && (t[1] = parseInt(t[1], 10)),
                  (n[t[0]] = t[1]);
              }
            }),
            n
  ...
  define("00b2b96ce3c5bd2694604cb13b8427d0", function (e, n, o) {
    ...
    var t = {};
    i({ version: "1.0.0", enterTime: +new Date(), id: legend.id }),
      ["business", "layoutMode", "checkDomain", "publishDomain"].forEach(
        function (e) {
  ...
  define("730b2f043e6ed2eb93f22e892def2fa0", function (e, a, i) {
    ...
    (d.mode = "expand" === p.mode ? "expand" : t.layoutMode),
      (d.list = "single" === p.list ? "single" : "all"),
      (d.phone = 1 === Number(p.phone) ? 1 : 0),
      (d.anim = 0 === Number(p.anim) ? 0 : 1),
      (d.load = 0 === Number(p.load) ? 0 : 1),
      /micromessenger/i.test(o)
        ? (d.app = "weixin")
        : /lite baiduboxapp/i.test(o)
        ? (d.app = "baiduLite")
        : /baiduboxapp/i.test(o)
        ? (d.app = "baidu")
        : /tieba/i.test(o) && (d.app = "tieba"),
      /windows|macintosh/gi.test(o) &&
        ((d.terminal = "pc"), (d.present = "pc"), d.phone || (d.ratio = 1)),
      "expand" === d.mode && (d.ratio = 1),
      ("object" == typeof _global_ ||
        (document.querySelector(".sfa-view") &&
          document.querySelector(".sfa-body"))) &&
        (d.present = "superframe");
    var s = $(".lg-container");
    s.addClass(d.mode).addClass(d.terminal),
      0 === d.anim && s.addClass("no-anim"),
      (i.exports = d);
  });
      ...
      return function (r, e, o) {
        ...
        return (
          r.border &&
            "none" !== r.border &&
            ((a = i = -r.borderSize * o),
            (d.borderWidth = r.borderSize * o + "px")),
          "dx" in r && ((a += r.dx * o), (i += r.dy * o)),
          (a || i) && (t += " translate3d(" + a + "px, " + i + "px, 0)"),
          r.rotate && (t += "rotate(" + r.rotate + "deg)"),
          (d.webkitTransform = d.transform = t),
          "simple" === e
            ? d
            : (r.opacity < 1 && (d.opacity = r.opacity),
              r.background && (d.background = r.background),
              "ellipse" === r.shape
                ? (d.borderRadius = "50%")
                : "rect" === r.shape &&
                  r.borderRadius &&
                  (d.borderRadius = r.borderRadius + "px"),
              "none" !== r.border &&
                ((d.borderStyle = r.border),
                (d.borderWidth = r.borderSize * o + "px"),
                (d.borderColor = r.borderColor)),
              "true" === r.shadow &&
                (d.boxShadow = [
                  r.shadowOffsetX + "px",
                  r.shadowOffsetY + "px",
  ...
  define("5b0a972c8df02b921306bfeb5ab3e543", function (e, a) {
    ...
    function r(e, a, o, s) {
      ...
      if (l) {
        ...
        (u.className = "lg-surface lg-surface-" + a.type),
          f.appendChild(u),
          e.appendChild(f);
        ...
        "gravity" in c &&
          0 !== c.gravity &&
          (u.classList.add("layer"), u.setAttribute("data-depth", c.gravity)),
          a.hidden && ((f.style.display = "none"), f.setAttribute("hidden", 1));
        var h = {
          data: a,
          base: o,
          trailerElement: f,
    ...
    var i = e("f7943761bde05ecaad007f47587e8df3"),
      ...
      o =
        (e("730b2f043e6ed2eb93f22e892def2fa0"),
        {
          coordinate: "top",
          rotate: 0,
          opacity: 1,
  ...
  define("28819c84a07bb88fc83272eb07e7725f", function (e, n, t) {
    ...
    t.exports = {
      ...
      createSingleInstance: e("5b0a972c8df02b921306bfeb5ab3e543")
        .createComponent,
      getComponentsByName: function (e) {
        ...
        return (
          this.instances.forEach(function (t) {
            (t.data.name === e ||
              (e instanceof RegExp && e.test(t.data.name)) ||
              (e instanceof Array && e.indexOf(t.data.name) >= 0)) &&
              n.push(t);
          }),
          n
        );
      ...
      centralize: function (e) {
        this.instances.forEach(function (n) {
          if ("central" === n.data.surface.coordinate) {
            ...
            for (var r in t)
              t.hasOwnProperty(r) && (n.trailerElement.style[r] = t[r]);
          }
        });
      }
    };
  ...
  define("35149c7e67b80058e263a93c32bd6945", function (e, t, o) {
    function i(e, t) {
      if (e && ((t = t || "info"), /^(success|info|error|warning)$/.test(t))) {
        n ||
          (n = $(
            '<div class="lg-toast-container lg-toast-top-center"></div>'
          ).appendTo("pc" === s.terminal ? ".lg-container" : "body"));
        var o = $(
          '<div class="lg-toast lg-toast-' +
            t +
            '" style="display: block;"><div class="lg-toast-' +
            t +
            '">' +
            e +
            "</div></div>"
  ...
  define("1cd7e669399af667140066e9cd051ef1", function (n, a, i) {
    function t(n) {
      if (e(n)) {
        ...
        var a = n.data.animations[n.animationIndex],
          i = n.trailerElement;
        if (a && i && "none" !== a.name) {
          (i.style["-webkit-animation-duration"] = i.style[
            "animation-duration"
          ] =
            (a.duration || 1) + "s"),
            (i.style["-webkit-animation-delay"] = i.style["animation-delay"] =
              (a.delay || 0) + 0.1 + "s"),
            (i.style["-webkit-animation-iteration-count"] = i.style[
              "animation-iteration-count"
            ] =
              a.repeat || 1),
            (i.style["-webkit-animation-direction"] = i.style[
              "animation-direction"
            ] =
              a.direction || "normal"),
            (i.className = "lg-trailer");
          var o = n.data.animations.map(function (n) {
              return n.name;
            }),
            m = i.classList;
          m.remove.apply(m, o),
            m.add(a.name, "animated"),
            $(i).one("webkitAnimationEnd animationend", function () {
              n.animationIndex + 1 < n.data.animations.length &&
                (n.animationIndex++, t(n));
            });
        }
      }
    }
    ...
    i.exports = { render: t, hasAnimation: e };
  });
  define("8c1294fef69efc4d21b17a2b4c41ec55", function (o, n, i) {
    ...
    function l(o, n) {
      if (window.Box && window.Box.os) {
        var i = { fullscreen: o, disablerefresh: n };
        window.Box.os.android
          ? window.Box.android.invokeApp(
              "Bdbox_android_searchFrame",
              "config",
              [JSON.stringify(i)]
            )
          : window.Box.os.ios &&
            window.Box.ios.invokeApp(
              "searchFrame",
              {
                action: "config",
    ...
    function d(o) {
      if (window.Box) {
        ...
        window.Box.os.android
          ? window.Box.android.invokeApp("Bdbox_android_utils", "callShare", [
              JSON.stringify(n),
              "console.log",
              "console.log"
            ])
          : window.Box.os.ios &&
            window.Box.ios.invokeApp("callShare", {
    ...
    i.exports = { invokeShare: d, enterFullScreen: e, exitFullScreen: r };
  });
  define("51aa36df4587602735b55872cbd92b40", function (o, i, n) {
    function e() {
      if (window.Box && window.Box.os) {
        var o = { fullscreen: 0, disablerefresh: 1 };
        window.Box.os.android
          ? window.Box.android.invokeLiteApp(
              "Bdbox_android_searchFrame",
              "config",
              [JSON.stringify(o)]
            )
          : window.Box.os.ios &&
            window.Box.ios.invokeLiteApp(
              "searchFrame",
              {
                action: "config",
      ...
      if (window.Box) {
        ...
        window.Box.os.android
          ? window.Box.android.invokeLiteApp(
              "Bdbox_android_utils",
              "callShare",
              [JSON.stringify(i), "console.log", "console.log"]
            )
          : window.Box.os.ios &&
            window.Box.ios.invokeLiteApp("callShare", {
    ...
    n.exports = { invokeShare: r, exitFullScreen: e };
  });
  define("def08931e80984bd9405df8b3fde7408", function (e, n, t) {
    function a(e) {
      var n = "ontouchstart" in document ? "tap" : "click",
        t = $("#default-share");
      (t && 0 !== t.length) ||
        (t = $('<div id="default-share"><div>')
          .css({
            position: "absolute",
            width: "100%",
            height: "100%",
            background:
              "rgba(0, 0, 0, 0.5) url(//fex.bdstatic.com/h5static/h5jscss/e988ceb436c96d014e3caee558938493_aaa.png) no-repeat 90% 3%",
          ...
          .appendTo($(".lg-container"))
          .on(n, function () {
            t.hide();
          })),
        t.show();
    }
    t.exports = { invokeShare: a };
  });
    ...
    function t(i) {
      ...
      if ((t.substr(d) >= "7.2.0" && (r = !0), r)) {
        if (
          ...
          "complete" === window.TiebaJsBridge.readyState
        ) {
          var n = { title: i.title, desc: i.desc, img: i.imgUrl, url: i.link };
          window.tb.TBHY_COMMON_Share.share(n);
        }
      } else e("def08931e80984bd9405df8b3fde7408").invokeShare(i);
    }
    r.exports = { invokeShare: t };
  });
  ...
  define("8ac31cf8ca7728e20495ca047cafc715", function (e, i, t) {
    var a = e("730b2f043e6ed2eb93f22e892def2fa0"),
      ...
      d = {
        ...
        desc: "\u767e\u5ea6H5\u5e73\u53f0\u652f\u6301",
        imgUrl:
          "https://gss0.baidu.com/94o3dSag_xI4khGko9WTAnF6hhy/doc/pic/item/ac345982b2b7d0a25e4d29d8cdef76094a369aea.jpg",
    ...
    t.exports = {
      ...
      setShareData: function (e) {
        (d.title = e.title || d.title),
          (d.desc = e.desc || d.desc),
          (d.imgUrl = e.imgUrl || d.imgUrl),
          (d.link = e.link || d.link);
      },
  ...
  define("106083f047adb7b61b2f80fb8b484022", function (e, a, t) {
    var n = !1,
      ...
      s =
        (e("00b2b96ce3c5bd2694604cb13b8427d0"),
        e("35149c7e67b80058e263a93c32bd6945")),
      r = e("85c8574dafa1cd69fb4e706f6deb30c0"),
    ...
    t.exports = {
      create: function (a) {
        ...
        o.classList.add("lg-backface"),
          d.background && (o.style.background = d.background),
          (o.style.opacity = Math.min(d.backgroundOpacity || 0, 1)),
          n.appendChild(o);
        var f = e("730b2f043e6ed2eb93f22e892def2fa0").ratio,
          b = t.pages.length;
        (r.components || []).forEach(function (e, a) {
          c.createSingleInstance(
            n,
            e,
            {
              pageIndex: s,
      ...
      prepare: function (e, a) {
        (a = void 0 === a ? 1 : a),
          c.instances.forEach(function (t) {
            t.base.stageIndex > -1 &&
              Math.abs(t.base.stageIndex - e) === a &&
              (t.animationIndex = 0);
          });
      },
      enter: function (e, a, t) {
        if (!(e < 0)) {
          ...
          c.instances.forEach(function (c) {
            if (
              (c.instance.pageChange && c.instance.pageChange(e, a),
              (c.base.stageIndex < 0 || c.base.stageIndex === e) &&
                c.instance.start &&
                !c.instance.$started &&
                (c.instance.start(), (c.instance.$started = !0)),
              c.base.stageIndex === e &&
                (!0 === t &&
                  void 0 !== c.animationIndex &&
                  ((c.animationIndex = 0), i.render(c)),
                !n && ["input", "text"].indexOf(c.data.type) >= 0))
            ) {
              if (
                -1 !== location.hostname.indexOf("baidu.com") ||
                "quick" === d.mode
              )
                return;
              s(
  ...
  define("8c4d03ebd59f9d83f5f66a4919b55cfd", function (e, a, t) {
    function n(e, a, t) {
      ...
      return (
        (n.className = "lg-page"),
        g.create({ data: e, container: n, stageIndex: t }),
        n
      );
    }
    function r(a, t) {
      var r = [],
        ...
        g = c.get();
      g.backStage && (r[-2] = n(g, g.backStage, -2)),
        g.frontStage && (r[-1] = n(g, g.frontStage, -1));
      var o = g.pages;
      return (
        "single" === a && ((o = []), (o[t] = g.pages[t])),
    ...
    function c(e) {
      var a = e[-2],
        t = e[-1];
      a && document.querySelector(".lg-back-stage").appendChild(a),
        t && document.querySelector(".lg-front-stage").appendChild(t);
    }
    var g = e("106083f047adb7b61b2f80fb8b484022");
    t.exports = { createAllPageElements: r, buildFrontAndBackStage: c };
  });
  define("df8aeaf2d6788adab98e713cb0a10819", function (e, t, n) {
    var r,
      o = e("5988e4bd85b0f1f6da6ca28126885c94"),
      ...
      h =
        ...
        document.querySelector(".lg-page-container"));
    n.exports = {
      build: function (e) {
        var t = o.get();
        a.buildFrontAndBackStage(e),
          (r =
            (t.pages[0].attributes.pageHeight
              ? t.pages[0].attributes.pageHeight
              : 650) * c.ratio);
        var n = document.createElement("div");
        (n.className = "lg-page"),
          ...
          h.appendChild(n),
          i.prepare(0, 0),
          i.enter(0, t.pages.length, !1),
          i.setShareInfo(t.pages[0]),
          this.resetHeight(t);
      },
        ...
        l.instances.forEach(function (n) {
          if (!n.playedOnceInStrip) {
            var o = t.getScreenHeight(),
              i = Math.max(e + 0.5 * o, o);
            (n.data.surface.y * c.ratio < i || r <= o + e) &&
              (s.render(n), (n.playedOnceInStrip = !0));
          }
        });
      },
      resetHeight: function (e) {
        function t(e) {
          ...
          t <= i ||
            ((t = Math.min(100, t)), (i = t), d.trigger("scrollReach", t));
        }
        e.pages[0];
        h.firstChild.style.height = r + "px";
        var n,
          o = this.getScreenHeight(),
          i = -1;
        t(0);
        var a = this;
        a.runAnimation(0),
      ...
      scrollTo: function (e) {
        ...
        if (t.test(e))
          ...
          (i = e.match(n)),
            2 === i.length
              ? (o = Math.round((parseInt(i[1], 10) * r) / 100))
              : console.warn(
                  "\u4f60\u586b\u5199\u7684\u6eda\u52a8\u4f4d\u7f6e\u683c\u5f0f\u4e0d\u5bf9\uff0c\u683c\u5f0f\u5982\uff1a50%."
                );
        }
  ...
  define("c6268a38b4d0819e37b9ae97ec9c9fd9", function (e, t, i) {
    function a(e) {
      (e.target && /^(input|textarea|a|select)$/i.test(e.target.tagName)) ||
        (e.target && /keep-default/g.test(e.target.className)) ||
        e.preventDefault();
    }
    ...
    i.exports = {
      build: function (e, t) {
          ...
          n &&
            d.push({
              ...
              transition: {
                ...
                duration:
                  void 0 === a.swipeDuration ? 800 : 1e3 * a.swipeDuration,
        ...
        f.on("activePageChanged", function (e) {
          ...
          r.prepare(a, 0),
            r.enter(a, i.pages.length),
            p.trigger("pageChangeStart", t + "_" + i.pages.length);
        }),
          f.on("swipeChanged", function () {
            setTimeout(function () {
              var e = f.currentPage.index;
              r.setShareInfo(i.pages[e]),
                p.trigger("pageChangeEnd", e + "_" + i.pages.length),
                p.trigger("pageReach", e + 1 + "_" + i.pages.length);
            }, 0);
          }),
          r.prepare(t, 0),
          r.enter(t, i.pages.length),
          r.setShareInfo(i.pages[t]),
          p.trigger("pageReach", t + 1 + "_" + i.pages.length);
        var u = document.querySelector(".lg-container");
        u.addEventListener("touchstart", a, !1),
          u.addEventListener("touchmove", a, !1),
          (this.swiper = f);
      },
  ...
  define("c00ecf28b793a7b3ab75e1e273e54fb9", function (o, a, e) {
    o("5988e4bd85b0f1f6da6ca28126885c94"),
      o("106083f047adb7b61b2f80fb8b484022"),
      o("730b2f043e6ed2eb93f22e892def2fa0"),
    ...
    e.exports = {
      build: function (o, a) {
        ...
        o.forEach(function (o) {
          ...
          $(".lg-container")
            .append(e)
            .css({ "background-color": "rgba(0,0,0,.5)", overflow: "auto" })
            .find(
              ".lg-back-stage, .lg-page-container, .lg-front-stage, .lg-loading-page"
            )
            .hide(),
  ...
  define("42c3b09b87b3081ca84c49e976349270", function (e, n, t) {
    ...
    function i(e, n) {
      e.forEach(function (e) {
        e.type === n &&
          ("control" === e.actionType
            ? c(e)
            : "link" === e.actionType
            ? f(e)
            : "download" === e.actionType && s(e));
      });
    }
    function c(e) {
    ...
    function s(e) {
      if ("weixin" === v.app) {
        ...
        n.css({
          ...
          zIndex: 1e3,
          backgroundImage:
            "url(https://gss0.baidu.com/9fo3dSag_xI4khGko9WTAnF6hhy/fex/pic/item/2934349b033b5bb5335b46643fd3d539b700bc98.jpg)",
          backgroundRepeat: "no-repeat",
          backgroundPosition: "right top",
          backgroundSize: "300px"
        }),
          $(".lg-container").append(n),
          n.on("tap", function () {
            n.remove(), (n = null);
          });
      } else {
        ...
        -1 !== o.indexOf("iPad") ||
        -1 !== o.indexOf("iPod")
          ? ((a = e.download.ios.trim()), (t = a.toLowerCase()))
          : ((a = e.download.android.trim()),
            (t = e.download.android.toLowerCase())),
          0 !== t.indexOf("javascript:") && a
            ? "pc" === v.terminal
              ? window.open(a)
    ...
    function f(e) {
      ...
      switch (e.link.prefix) {
        ...
        case "tel:":
          ...
          r >= 0 && (o = o.substr(r + 3)),
            "pc" === v.terminal
              ? window.open(e.link.prefix + o, "_blank")
              : (("baidu" !== v.app && "baiduLite" !== v.app) ||
                  "superframe" !== v.present ||
                  y.exitFullScreen(),
                (window.location = e.link.prefix + o)),
            n || (n = "phone"),
            (t = e.link.prefix + o);
          break;
        case "#page":
      ...
      n && m.trigger("event", { action: "link", type: n, content: t });
    }
    function d(e) {
      if (!e) return -1;
      if (/^\d+$/.test(e)) return parseInt(e, 10);
      for (
        var n = e.replace(/\s|[^,\-\d]/g, "").split(","), t = [], a = 0;
        a < n.length;
        a++
      ) {
        var o = n[a];
    ...
    function l() {
      if (window.Shake) {
        new window.Shake({ threshold: 15 }).start(),
          window.addEventListener("shake", p, !1);
      }
    }
    function u() {
    ...
    var b,
      g = e("5988e4bd85b0f1f6da6ca28126885c94"),
    ...
    m.on("form", function () {
      ...
      (t.exports = { init: a, eventDeal: i, destroy: u });
  });
  define("40ca95ae6758e8a27f2ea109d3c7c901", function (e, n, i) {
    ...
    function c(e, n) {
      e &&
        o(
          "//fex.bdstatic.com/h5static/h5jscss/ZeroClipboard.min.js",
          function () {
            ...
            window.ZeroClipboard.config({
              ...
              new window.ZeroClipboard(e[0]).on("copy", function (i) {
                var t = i.clipboardData,
                  ...
                  a = "store";
                0 === window.location.pathname.indexOf("/h5") && (a = "user"),
                  t.setData("text/plain", n + "/" + a + "/" + o),
                  e.text("\u94fe\u63a5\u5df2\u590d\u5236"),
                  setTimeout(function () {
                    e.text("\u590d\u5236 H5 \u94fe\u63a5");
                  }, 3e3);
    ...
    function d(e) {
      for (var n = "", i = 0, t = e.length; i < t; i++) {
        ...
        n +=
          ...
          '" data-height="' +
          o.height +
          '"><div class="phone-type"><span class="apple"></span>' +
          o.name +
    ...
    function s() {
      ...
      var p = v.parseQueryString(location.search),
        ...
        m = $(
          '<div class="arrow"><div class="up"></div><div class="down"></div></div>'
        );
      ...
      $("body").append($('<div class="outer-container"></div>').append(x)),
        n(),
        (window.onresize = n),
        u &&
          (f.append(
            $(
              '<div class="phone-size">' +
                d([
                  { phone: "p5", app: "weixin", height: 630, name: "5" },
                  { phone: "p6", app: "weixin", height: 644, name: "6" },
                  {
                    phone: "p6p",
                    app: "weixin",
                    height: 650,
          ...
          $(".mid-content").on("click", ".phone-size .item", function (e) {
            ($(".mid-content .phone")[0].style.height =
              $(this).data("height") + "px"),
              $(".phone-size .item").removeClass("active"),
              $(this).addClass("active");
            var n = document.querySelector(".lg-container");
            h.centralize(n.clientHeight), C && C.onresize && C.onresize();
          })),
        1 === Number(p.channel) &&
          (a(Number(p.isLogin), Number(p.useTemplate)),
          c(Number(p.copyUrl), decodeURIComponent(p.origin))),
        "preview" === p.scene && $(".open-new-window").show();
      var k = window.location.href.replace("scene=preview", "");
      if (
        (p &&
          p.ip &&
          (k = k
            .replace(window.location.host, p.ip)
            .replace("&ip=" + p.ip, "")),
        o("", function () {
        ...
        $("body")
          .on("click", ".open-new-window", function () {
          ...
          .on("click", ".login-btn", function () {
            var e = { redirect: "login", channel: 3 };
            window.parent.postMessage(JSON.stringify(e), "*");
          }),
        "multi" === l.layoutMode)
      ) {
        var C = e("0f8310c1b66ce9e70848c86aecf55a81")("multi");
        $("body").on("click", ".arrow .up", i).on("click", ".arrow .down", s),
          window.addEventListener(
            "keydown",
            function (e) {
              38 === e.keyCode || 37 === e.keyCode
                ? (i(), e.preventDefault())
  ...
  define("3856c3b0058eb920dc8f4a90536221d1", function (n, e, t) {
    ...
    t.exports = { install: i, scrollContainer: window };
  });
  define("db54a8aef2d9d87677687fbbf5259fd7", function (n, i, o) {
    o.exports = { install: function () {}, scrollContainer: window };
  });
  ...
  define("a0960dc86bc19e9c76d2e24033054b67", function (e, t, o) {
    function n(e, t) {
      ...
      return e && e.components
        ? (e.components.forEach(function (e) {
            "audio" === e.type &&
              e.attributes &&
              "true" === e.attributes.auto &&
              t < 1 &&
              (o.audios.push(e.attributes.url), (e.attributes.aid = l++)),
              "panel" === e.type &&
                e.attributes &&
                e.attributes.components &&
                (o = a(o, i(e.attributes, t)));
          }),
          o)
        : o;
    }
    function a(e, t) {
      ...
      e = e || {};
      for (var n in e)
        e.hasOwnProperty(n) && ((e[n] = e[n] || []), (o[n] = e[n].slice()));
      t = t || {};
      for (n in t)
        t.hasOwnProperty(n) &&
          ((t[n] = t[n] || []),
          (o[n] = o[n] || []),
          (o[n] = o[n].concat(t[n].slice())));
      return o;
    }
    function i(e, t) {
    ...
    function r(e) {
      e.forEach(function (e) {
        ...
        (t.className = "lg-component-audio-core"),
          (o.src = e),
          t.appendChild(o),
          document.querySelector(".lg-container").parentNode.appendChild(t),
          t.play(),
    ...
    function d(e) {
      if (((p = this.onLoad), this.audio)) {
        ...
        (t = a(t, n(e.backStage, -2))),
          e.pages.forEach(function (e, o) {
            t = a(t, n(e, o));
          }),
          r(t.audios);
      }
    ...
    var s = { audios: [] };
    legend.loading = { audios: [] };
    var l = 0,
      p = null;
    (u.booted = !1), (o.exports = { audio: !0, onLoad: null, load: d });
  });
  ...
  define("5932ae9bdc8247f92ca4d3881e82fb2a", function (t, e, a) {
      ...
      return t && t.components
        ? (t.components.forEach(function (t) {
            ...
            "label" === t.type &&
              t.attributes &&
              t.attributes.fonts &&
              (a.fonts = a.fonts.concat(
                t.attributes.fonts.map(function (t) {
                  return t.fontName;
                })
              )),
              "counter" === t.type &&
                ...
                a.fonts.push(t.attributes.fontFamily),
              "loadingprogress" === t.type &&
                t.attributes &&
                t.attributes.fontFamily &&
                a.fonts.push(t.attributes.fontFamily),
              "audio" === t.type &&
                t.attributes &&
                "true" === t.attributes.auto &&
                e < 1 &&
                x &&
                (a.audios.push({
              ...
              "panel" === t.type &&
                t.attributes &&
                t.attributes.components &&
                (a = i(a, s(t.attributes, e)));
          }),
          a)
        : a;
    }
    function i(t, e) {
      ...
      t = t || {};
      for (var n in t)
        t.hasOwnProperty(n) && ((t[n] = t[n] || []), (a[n] = t[n].slice()));
      e = e || {};
      for (n in e)
        e.hasOwnProperty(n) &&
          ((e[n] = e[n] || []),
          (a[n] = a[n] || []),
          (a[n] = a[n].concat(e[n].slice())));
      return a;
    }
    function o(t) {
      for (var e = t.concat(), a = 0; a < e.length; ++a)
        for (var n = a + 1; n < e.length; ++n)
          e[a] === e[n] && e.splice(n--, 1);
      return e;
    }
    function r(t, e) {
      var a = JSON.parse(JSON.stringify(t)),
        n = {};
      for (var i in a)
        a.hasOwnProperty(i) && (n[i] = -1 === e.indexOf(i) ? o(a[i]) : a[i]);
      return n;
    }
    function s(t, e) {
    ...
    function f(t) {
      ...
      if (
        ...
        (a.innerHTML = e),
          (a.style.cssText = "position: absolute; top: -99999px"),
          document.querySelector(".lg-container").parentNode.appendChild(a);
      }
    }
    function l(t, e) {
      c(t, d, function (t, a) {
    ...
    function g() {
      for (
        var e = t("28819c84a07bb88fc83272eb07e7725f").instances,
          a = [],
          n = 0,
          i = e.length;
        n < i;
    ...
    function p(t, e) {
      ...
      if (a && a.length) {
        t > e && (t = e);
        for (
          var n = parseInt((t / e) * 100, 10), i = 0, o = a.length;
          i < o;
          i++
        ) {
          var r = a[i];
    ...
    function m(t) {
      var e = document.querySelector(".lg-loading-page");
      t.loadingPage || (t.loadingPage = {}),
        t.loadingPage && h.create({ data: t, container: e, stageIndex: -3 });
    ...
    function v(t) {
      t.forEach(function (t) {
        ...
        (e.className = "lg-component-audio-core"),
          (a.src = t.src),
          t.loop && (e.loop = !0),
          e.appendChild(a),
          document.querySelector(".lg-container").parentNode.appendChild(e),
          e.play(),
          document.addEventListener("WeixinJSBridgeReady", function () {
            e.play();
          }),
        ...
        c(a.images, function () {
          ...
          o
            ? (setTimeout(function () {
              ...
              (d.timer = setTimeout(d, 5e4)))
            : d();
        });
    }
    var h = t("106083f047adb7b61b2f80fb8b484022"),
      S = [],
      P = { images: [], fonts: [], audios: [] };
    legend.loading = { audios: [] };
    var w = 0,
      E = 0,
      N = null,
      x = !0;
    (d.booted = !1), (a.exports = { audio: !0, onLoad: null, load: y });
  });
  ...
  define("17351264bd0101fcfca268289abbc71d", function (e, n, t) {
    ...
    function f(n, t, a) {
      function o() {
        var t = +new Date() - E.enterTime,
          a = e("8c4d03ebd59f9d83f5f66a4919b55cfd").createAllPageElements(
            m.list,
            r
          );
        s.build(a, r),
          ...
          document
            ...
            .setAttribute("data-limit-x", 0);
        var o = document.querySelectorAll(".lg-page"),
          d = [n.backStage].concat(n.pages).concat([n.frontStage]);
        window.Parallax &&
          d.forEach(function (e, n) {
            var t = {};
            "horizon" === e.attributes.gravityLock
              ? (t = { limitY: 0 })
              : "vertical" === e.attributes.gravityLock && (t = { limitX: 0 }),
              new window.Parallax(o[n], t);
          }),
          (y = !0),
          g.trigger("loadTime", t),
          g.trigger("loadingEnd", i());
      }
      w.init(n),
        p.install(b),
        (p.onUninstall = function () {
          b();
        });
      var r = 0;
      ...
      (s = e("0f8310c1b66ce9e70848c86aecf55a81")(m.mode, p)),
        g.trigger("loadingStart", i());
      ...
      0 === m.load
        ...
        : (f.onLoad = function () {
            o(),
              h.init(),
              legend.onApiReady && legend.onApiReady(),
    ...
    function b() {
      v.instances.forEach(function (e) {
        ...
        window.removeEventListener("resize", v.resizer, !1),
        s.destroy();
      var e = document.querySelector(".lg-container");
      e.parentNode.removeChild(e), l(), h.destroy(), g.trigger("leave", i());
    }
    var s,
      g = e("85c8574dafa1cd69fb4e706f6deb30c0"),
      ...
      y = !1,
      L = [];
    t.exports = { init: f, ready: u, destroy: b };
  });
  ...
  define("dc12d6d28d43f52faf351f0eca9ee563", function (e, n, t) {
    function c(e, n) {
      (e = a[e]),
        "component" === e && ((e = "component:" + n.name), (n = n.content)),
  ...
  define("cd694f20bc5cf60094ada1af49cc7445", function (e, n, a) {
    function t(e, n) {
      ...
      (e = d[e]),
        "component" === e
          ? f.indexOf(n.name) >= 0 && ((e = n.name), (a = n.content))
          : "event" === e
          ? ((e = n.type), (a = n.content))
          : (a = "object" == typeof n ? JSON.stringify(n) : n),
      ...
      return (
        ...
        a && (p.content = a),
        [
          r.makeUrl("https://sp0.baidu.com/-rU_dTmfKgQFm2e88IuM_a/w.gif", p),
          r.makeUrl(" https://ada.baidu.com/nclick/index", p)
        ]
      );
    }
    ...
    a.exports = {
      condition: function () {
        ...
        return (
          "superframe" === o.present ||
          (e.indexOf("fc") > -1 && e.indexOf("param") > -1)
        );
      },
      act: function (e, n) {
  ...
  define("cd1ee1b1b3a589855ea931cfc0c531f3", function (e, n, o) {
    ...
    var c = e("85c8574dafa1cd69fb4e706f6deb30c0"),
      d = [
        e("dc12d6d28d43f52faf351f0eca9ee563"),
        e("cd694f20bc5cf60094ada1af49cc7445"),
        e("917e26043c9fc2259960d9a37e69040c")
      ],
      i = [
        "pv",
        "loadingStart",
    ...
    c.on(i.join(" "), function (e, n) {
      setTimeout(function () {
        d.forEach(function (o) {
          if (o.condition())
            for (
              var c = o.act(e.type, n), d = [].concat(c), i = 0;
              i < d.length;
              i++
            )
              d[i] && a(d[i]);
      ...
      var c = void 0 !== o.aid,
        p = $(
          '<div class="lg-component-audio"><div class="lg-component-audio-play"></div><div class="lg-component-audio-pause"></div>' +
            (c
              ? ""
              : '<audio class="lg-component-audio-core" preload="auto"><source></audio>') +
            "</div>"
        ),
        l = p[0],
        ...
        y = $(r).find("source")[0];
      if (
        (r.play || (r.play = r.pause = function () {}),
        (r.onplay = d),
        (r.onended = r.onpause = d),
        d(),
        !i.inEditor)
      ) {
        var h;
      ...
      var m = {},
        b = {
          ...
          pageChange: function (n, o) {
            "page" === i.stageType &&
              (i.pageIndex === n
                ? "true" !== m.auto || i.inEditor || (t(), s())
                : u());
          },
          render: function (n) {
            /^https?/.test(n.url) &&
              (c || (y.src = n.url),
              this.seticon(f, n.pauseicon),
              this.seticon(g, n.playicon),
              "true" === n.loop && (r.loop = !0),
              "true" !== n.auto ||
                "page" === i.stageType ||
                i.inEditor ||
                (t(), s()));
  ...
  define("33f8627efeaa0b20ec58d61c17910cee", function (e, t) {
    function r(e, t, r, a) {
      ...
      if ("true" == t.touchevent) {
        ...
        l
          ? ($(s).on("touchstart", n), $(s).on("touchend", o))
          : ($(s).on("mousedown", n), $(s).on("mouseup", o));
      }
      var u = {
        name: "\u56fe\u7247",
        attributeChange: function (e) {
          ...
          var r = "src";
          i.lazy && ((r = "data-src"), s.classList.add("swiper-lazy")),
            s.setAttribute(r, e.src),
            "none" === i.stroke
              ? (s.style.borderStyle = "none")
              : (s.style.borderStyle = i.strokeType),
            "true" == e.keepDefault && s.classList.add("keep-default"),
            (s.style.borderRadius = i.cornerRadius + "px"),
            (s.style.borderColor = i.stroke),
            (s.style.borderWidth = (i.strokeWidth || 0) + "px");
        },
  ...
  define("db27f90d95fe98519ad67189c9158e73", function (t, e) {
    function a(t, e, a, n, i) {
      ...
      r.classList.add("lg-component-label"),
        (r.style.display = "table-cell"),
        (r.style.fontSize = l * i.ratio + "px");
      var d = a,
        h = {},
        c = {
          name: "\u6587\u672c",
          attributeChange: function (e) {
            ...
            (r.innerHTML =
              '<div style="width: ' + Math.ceil(d) + 'px">' + n + "</div>"),
              (r.style.verticalAlign = h.verticalAlign),
              (this.name = r.textContent.substr(0, 10)),
              "true" === h.shadow
                ? (r.style.textShadow = [
                    h.shadowOffsetX + "px",
                    h.shadowOffsetY + "px",
              ...
              "true" === h.allowScroll &&
                ...
                r.classList.add("keep-default"),
                r.addEventListener("touchstart", s, { passive: !0 }),
                r.addEventListener("touchmove", s, { passive: !0 }));
          },
